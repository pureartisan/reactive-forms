...
export const PrimeImageField = forwardRef(
    <I extends FileInputBase<FileData>>(
        props: PrimeImageFieldProps<FileData, I>,
        ref: any
    ) => {
        ...
        >
            ...
            <div className={clsx("rf-image-input",
                        props.input?.inputClassName
                    )}
                >
                    <Image
                        ref={ref}
                    ...
                    <div className="rf-actions">
                        ...
                        {props.control?.dirty && props.resetLabel && (
                            <Button
                                className="rf-reset p-button-link"
                                onClick={handleReset}
                            >
                                {props.resetLabel}
                            </Button>
